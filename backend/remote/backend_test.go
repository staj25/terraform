...
func TestRemote_forceLocalBackend(t *testing.T) {
	// Set the TF_FORCE_LOCAL_BACKEND flag so the remote backend will set
	// b.Local to the backend with itself as embedded backend.
